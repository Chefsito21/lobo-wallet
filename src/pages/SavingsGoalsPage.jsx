...
const SavingsGoalsPage = () => {
  ...
  const fetchGoals = async () => {
    try {
      ...
      toast.error(
        'Error al cargar objetivos de ahorro'
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await pb.collection('savingsGoals').create(
          data,
          { $autoCancel: false }
        );
  ...
  const handleDelete = async (id) => {
    ...
    if (
      !window.confirm(
        '¿Eliminar este objetivo de ahorro?'
      )
    ) return;

    try {

      await pb.collection('savingsGoals').delete(
        id,
        { $autoCancel: false }
      );
  ...
  const handleToggleComplete = async (goal) => {
    try {
      ...
      toast.success(
        goal.completed
          ? 'Objetivo marcado como incompleto'
          : 'Objetivo completado'
      );
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Realiza seguimiento de tus metas de ahorro y objetivos financieros"
        />
      </Helmet>
              ...
              <CardContent>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="description"
                      placeholder="¿Por qué estás ahorrando para esto?"
