...
const MonthlySummaryPage = () => {
  ...
  const getAvailableMonths = () => {
    ...
    // Si no existen transacciones, permitir al menos el mes actual
    if (months.size === 0) {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Visualiza tu resumen financiero mensual y el desglose de tus gastos"
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="shadow-lg border-0 bg-card interactive-hover border-b-4 border-b-[#EF4444]">
            ...
            <CardContent>
              <div
                className="text-4xl font-bold text-[#EF4444]"
                style={{ fontVariantNumeric: 'tabular-nums' }}
              >
